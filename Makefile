...
main.o: main.c
	gcc -fno-stack-protector -fpic -fshort-wchar -mno-red-zone -Wall -I/usr/include/efi -I/usr/include/efi/x86_64 -I/usr/include/efi/protocol -DEFI_FUNCTION_WRAPPER -c main.c -o main.o
